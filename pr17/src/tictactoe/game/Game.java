...
public class Game {
    ...
    public static void game(int size) {
        GameSettings settings = new GameSettings(size, Const.p1Name, Const.p2Name);
        ...
        while (!endgame) {
            board.display(masssize1);
            String currentName = (currentplayer == 'X') ? settings.player1Name : settings.player2Name;
